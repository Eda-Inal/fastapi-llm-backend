...
_ROLE_WITH_TOOLS = (
    ...
    "- In every Thought after an Observation, repeat the checklist. "
    "To mark an item [x], you MUST quote the exact phrase from the Observation that "
    "answers it. Format:\n"
    "  [x] 1. <item> — \"<exact quote from the Observation>\"\n"
    "  If you cannot find an exact quote, keep the item [ ] and search again with "
    "different keywords. Never mark [x] with a summary or paraphrase — only a "
    "direct quote from the retrieved text.\n"
    "  Then state which item you are addressing next.\n"
    ...
    "- In your Final Answer, use the quoted evidence from your checklist. "
    "Do not discard the quotes and write a generic summary.\n"
...
_EXAMPLE_TEMPLATE = (
    ...
    "Thought:\n"
    "  [x] 1. Onboarding guide instructions for dev environment setup — "
    "\"Clone the repository, then run scripts/setup.sh to install dependencies "
    "and configure the local environment.\"\n"
    ...
    "Thought:\n"
    "  [x] 1. Key findings — \"The audit identified three critical gaps: "
    "missing access logs, unencrypted backups, and outdated password policies.\"\n"
    ...
    "Thought:\n"
    "  [x] 1. Key findings — \"three critical gaps: missing access logs, "
    "unencrypted backups, and outdated password policies.\"\n"
    "  [x] 2. Compliance requirements — \"maintain access logs for 12 months, "
    "encrypt backups using AES-256, and enforce password rotation every 90 days.\"\n"
    "  All items complete. Writing Final Answer.\n"

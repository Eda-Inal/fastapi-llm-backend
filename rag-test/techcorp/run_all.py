...
Usage:
    python rag-test/techcorp/run_all.py                    # all questions
    python rag-test/techcorp/run_all.py --range Q11-Q20    # Q11 through Q20
    python rag-test/techcorp/run_all.py --range Q05        # single question
...
def main():
    ...
    parser.add_argument("--range", default=None, help="Question range (e.g. Q11-Q20, Q05)")
